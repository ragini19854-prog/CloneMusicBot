...
def private_panel(_):
    buttons = [
        ...
        [
            ...
            InlineKeyboardButton(text="cℓσηє", callback_data="clone_page", style=enums.ButtonStyle.PRIMARY),
        ],
        [
            InlineKeyboardButton(text="ѕυρρσят", callback_data="support_page", style=enums.ButtonStyle.PRIMARY),
            InlineKeyboardButton(text="ѕσυяcє", callback_data="gib_source", style=enums.ButtonStyle.PRIMARY),
        ],
        [
