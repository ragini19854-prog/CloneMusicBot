...
from MadaraMusic.utils.database import is_active_chat, is_nonadmin_chat
from MadaraMusic.utils.decorators.language import languageCB
from MadaraMusic.utils.inline import close_markup, speed_markup
...
@languageCB
async def speed_play_callback(client, callback_query, _):
