...
from MadaraMusic.utils.decorators.admins import ActualAdminCB
from MadaraMusic.utils.decorators.language import language, languageCB
from MadaraMusic.utils.inline.settings import (
    auth_users_markup,
    playmode_users_markup,
    setting_markup,
    vote_mode_markup,
)
from MadaraMusic.utils.inline.start import private_panel
...
async def vote_change(client, CallbackQuery, _):
    # ✅ FIX: Removed "command = matches[0].group(1)" because this regex has no groups.
    try:
        await CallbackQuery.answer(_["set_cb_3"], show_alert=True)
    except:
        pass
